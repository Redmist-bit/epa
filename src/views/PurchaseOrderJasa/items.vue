    ...
    <v-toolbar flat dark dense outlined color="white" class="elevation-5">
      <v-dialog v-model="dialog" max-width="1000px" persistent>
        ...
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn dark color="blue darken-4" @click="accjasa">
    ...
    <v-card color="grey lighten-3" class="pa-2 rounded-lg elevation-0">
      ...
      >
        <e-columns>
          ...
          <e-column field="Keterangan" headerText="Keterangan" width="300">
          </e-column>
          <e-column
            field="Jumlah"
            headerText="Jumlah"
            ...
            const data = {
              NoUrut:
                index == 0
                  ? index +
                    1 +
                    parseInt(this.items[this.items.length - 1].NoUrut)
                  : parseInt(this.items[this.items.length - 1].NoUrut) + 1,
              Jumlah: 1,
              Rasio: 1,
              Diskon: 0,
              DiskonRp: 0,
    ...
    onActionComplete(args) {
      if (args.requestType === "beginEdit") {
        ...
        if (this.title == "Ubah") {
          ...
          //   this.maxUpdateJumlah =
          //     parseInt(args.rowData.rwl.Jumlah) -
          //     parseInt(args.rowData.Jumlah) +
          //     parseInt(args.rowData.Jumlah);
          // } else {
      ...
      if (args.requestType === "save") {
        ...
        this.items = data.map((item) => {
          item.Perkiraan =
            item.Perkiraan == null || item.Perkiraan == item.Nama
