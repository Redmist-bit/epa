    ...
    >
      ...
      >
        ...
        <table style="width: 50%; margin-top: 20px">
          ...
          <tr>
            <td style="width: 25%">Biaya Perbaikan</td>
            <td
              style="width: 37%; text-align: right; padding-right: 20px"
              colspan="2"
            >
              {{
        ...
        <!-- <v-row style="font-weight:bold;">
                    ...
                    <v-col style="margin-left:-100px;">
                        <p style="margin-left:-100px;">140,000.00</p>
                    </v-col>
                </v-row> -->
        <!-- <v-row style="font-weight:bold;">
                    <v-col>
                    ...
                    <v-col style="margin-left:-100px;">
                        <p style="margin-left:-100px;">300,000.00</p>
                    </v-col>
                </v-row> -->
