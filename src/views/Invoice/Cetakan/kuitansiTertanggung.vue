    ...
    >
      ...
      >
        ...
        <table style="width: 65%">
          <tr>
            <td style="width: 30%">Deductible</td>
            <td style="width: 5%">:</td>
            <td style="width: 20%; text-align: right">
              {{
                dataReport.KTtg.toLocaleString(undefined, {
          ...
          <tr>
            ...
            <td style="width: 20%; text-align: right">
              {{
                dataReport.Kexc.toLocaleString(undefined, {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })
              }}
          ...
          <tr>
            ...
            <td style="width: 20%; text-align: right">
              {{
                dataReport.Kund.toLocaleString(undefined, {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })
              }}
          ...
          <tr>
            ...
            >
              {{
                dataReport.KPpn.toLocaleString(undefined, {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })
              }}
...
export default {
  ...
  created() {
    ...
    this.dataReport.KTtg = parseFloat(this.$route.params.data.KTtg);
    this.dataReport.Kexc = parseFloat(this.$route.params.data.Kexc);
    this.dataReport.KPpn = parseFloat(this.$route.params.data.KPpn);
    this.dataReport.Kund = parseFloat(this.$route.params.data.Kund);
    this.dataReport.Total =
      this.dataReport.KTtg +
      this.dataReport.Kexc +
      this.dataReport.KPpn +
      this.dataReport.Kund;
