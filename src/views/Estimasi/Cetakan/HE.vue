      ...
      >
        ...
        <!-- <v-row>
                    ...
                    <v-col>
                        <v-row>
                            <v-col>
                                <p style="text-align:right; font-weight:bold;">Samarinda, 24 November 2021</p>
                            </v-col>
                        </v-row>
                    </v-col>
                </v-row> -->
        ...
        <table>
                ...
                <div class="page">
                  ...
                  <table>
                    <thead>
                      ...
                      <!-- <tr>
                                                <th colspan="4" style="text-align:left">MATERIAL</th>
                                            </tr> -->
                    </thead>
                  </table>
                  <table>
          ...
          <tfoot>
            ...
            <div style="display: inline-block; margin-top: 10px">
              ...
              <p style="font-weight: bold">HEAD OF OPERATION</p>
            </div>
          </tfoot>
        </table>
      </div>
