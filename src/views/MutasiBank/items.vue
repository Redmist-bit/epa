    ...
    <v-card color="grey lighten-3" class="pa-2 rounded-lg elevation-0">
      ...
      >
        <e-columns>
          ...
          <e-column field="Perkiraan" headerText="Perkiraan" width="170">
          </e-column>
...
export default {
  ...
  data() {
    return {
      ...
      pageSettings: { pageSizes: ["5", "20", "50", "100"] },
  ...
  computed: {
    formTitleItemsPerkiraan() {
      return this.editedIndex === -1 ? "Tambah barang" : "Isi Detail Mutasi";
    },
  },
  methods: {
    onResize() {
