                  ...
                  <table class="isi" style="margin-top: -10px">
                    ...
                    <tbody>
                      ...
                      <!-- <tr>
                                                ...
                                                <td style="width:70%;">Pembayaran pembelian 0101/WI/2109/000548 (INTERNAL PALEMBANG 2021)</td>
                                                <td style="width:25%; text-align:right;">250.000,00</td>
                                            </tr> -->
                    </tbody>
                  </table>
                </div>
...
export default {
  ...
  created() {
    ...
    this.dataReport.items = this.$route.params.data.itemspembelian
      .map((m) => {
        m.Keterangan =
          "Pembayaran pembelian " +
          m.faktur.KodeNota +
          " (" +
          m.faktur.wo.NomorPolisi +
          ")";
        return m;
      })
      .filter((f) => f.Jumlah > 0);
  ...
  methods: {
    countCetak(id, token) {
      api
        .put("countCetakan/" + id + "?token=" + token, { modul: "HUTANG" })
        .then((res) => {
          console.log(res);
        })
        .catch((err) => {
