                          ...
                          >
                            ...
                            <v-tab-item :eager="true">
                              <ItemsPembelian
                                ...
                                v-bind:itemsPekerjaan="dataPekerjaan"
...
export default {
  ...
  methods: {
    ...
    async savePilihno_po() {
      this.title = "Tambah";
      await api
        .get("items-po-jasa/" + this.id_po + "?token=" + this.token)
        .then(
          (res) => {
    ...
    TambahData() {
      ...
      this.editedItem.items = this.ItemsPembelian.map((j) => {
        ...
        j.JenisPekerjaan = this.dataPekerjaan.find(
      ...
      this.isLoading = true;
      api
        .post("/pembelian-jasa?token=" + this.token, this.editedItem)
        .then((res) => {
    ...
    UpdateData() {
      ...
      this.editedItem.hapus_items = this.hapus_items.map((f) => {
        f.JenisPekerjaan = this.dataPekerjaan.find(
      ...
      api
        .put(
          "/pembelian-jasa/" + this.editedItem.id + "?token=" + this.token,
          this.editedItem
        )
        .then((res) => {
          console.log(res);
    ...
    commandClick: function (args) {
      ...
      if (args.target.classList.contains("Details")) {
        ...
        api
          .get("pembelian-jasa/" + args.rowData.id + "?token=" + this.token)
          .then(
            (res) => {
    ...
    getDataPembelian(from, to) {
      ...
      this.isLoading = true;
      api
        .get("/pembelian-jasa/" + from + "/" + to + "/?token=" + this.token)
        .then(
          (res) => {
            this.isLoading = false;
